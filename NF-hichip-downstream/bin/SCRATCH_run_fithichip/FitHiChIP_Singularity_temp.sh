...
singularity exec -B "$BINDARG" /nemo/lab/briscoej/working/hamrude/singularity/fithichip.sif bash "/FitHiChIP/FitHiChIP_HiCPro.sh" -C "$ConfigFile" -s
