...
cell_ids <- ArchR_donor$cellNames

# transfer cluster IDs
transfer_ids <- ArchR_donor$clusters
ArchR <- addCellColData(ArchR, force = TRUE,
                        data = all_cluster_ids,
                        cells = all_cell_ids, 
                        name = "transferred_clusters")
print(table(ArchR$transferred_clusters))

# transfer cluster IDs
cell_ids <- ArchR_donor$cellNames
cluster_ids <- paste0(stage, "_", ArchR_donor$clusters)
ArchR <- addCellColData(ArchR, force = TRUE,
                        data = all_cluster_ids,
                        cells = all_cell_ids, 
                        name = "transferred_clusters")
