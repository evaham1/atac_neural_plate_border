...
if(length(stage) == 1){
  ...
  cluster_res = list(HH5 = 2.4, HH6 = 2.2, HH7 = 3.5, ss4 = 3.2, ss8 = 3.7)[[stage]]
  # cluster res set so same number cell states found in sc: 11 at HH5 D, 10 at HH6 D, 14 at HH7, 13 at 4ss D and 13 at 8ss
