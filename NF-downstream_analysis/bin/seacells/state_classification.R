...
if(length(stage) == 1){
  ...
  cluster_res = list(HH5 = 2.4, HH6 = 2.2, HH7 = 3.1, ss4 = 3.2, ss8 = 3.3)[[stage]]
  # cluster res set so same number cell states found in sc: 11 at HH5, 10 at HH6, 14 at HH7, 13 at 4ss and 13 at 8ss
